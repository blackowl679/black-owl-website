            ...
            {activeTab === 1 && (
              <div className="space-y-8 sm:space-y-12">
                ...
                <div className="space-y-8 sm:space-y-12">
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                              ...
                              <div className="order-2">
                                <div className="relative">
                                  ...
                                  {/* Tech corners */}
                                  <div className="absolute top-2 left-2 w-4 h-4 border-l-2 border-t-2 border-accent-400/40" />
                                  <div className="absolute bottom-2 right-2 w-4 h-4 border-r-2 border-b-2 border-accent-400/40" />
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  {/* Features without Video - Grid Layout */}
                      ...
                      return (
                        ...
                        >
                          ...
                          <motion.div
                            className="absolute inset-0 bg-gradient-to-r from-accent-500/5 to-primary-500/5 rounded-xl sm:rounded-2xl"
                            animate={{ opacity: [0.3, 0.7, 0.3] }}
                            transition={{ duration: 3, repeat: Infinity, delay: (index + 2) * 0.5 }}
                          />
