          ...
          >
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-4 sm:left-6">
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm relative overflow-hidden group"
              >
                {/* Button glow */}
                <motion.div
