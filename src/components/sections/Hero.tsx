...
const Hero: React.FC = () => {
  ...
  return (
    <>
      {/* CSS personalizado para forzar espaciado móvil */}
      <style jsx>{`
      ...
      <section id="inicio" className="min-h-screen relative overflow-hidden">
        ...
        {/* CONTAINER CON CLASES PERSONALIZADAS */}
        <div className="hero-container relative z-10 px-4 sm:px-6 lg:px-8 pt-8 sm:pt-24 lg:pt-28 pb-8 flex items-center min-h-screen">
          <div className="w-full max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-16 items-center">
              ...
              <motion.div
                ...
                className="hero-content text-white space-y-1 sm:space-y-6 lg:space-y-8 text-center lg:text-left -mt-4 sm:mt-0"
              >
                {/* Main Title */}
                <motion.div
